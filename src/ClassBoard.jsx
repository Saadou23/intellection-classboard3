...
import { Plus, Edit2, Trash2, Save, X, Monitor, Settings, AlertCircle, Maximize, Clock, BarChart3, Sliders, Building2, Calendar, Printer, Moon, FileDown } from 'lucide-react';
      ...
      <div className="bg-blue-900 text-white p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
           ...
           <button
  onClick={() => setShowSoundTester(true)}
  className="bg-pink-600 hover:bg-pink-700 px-4 py-2 rounded-lg flex items-center gap-2 text-sm"
>
  🎵 Tester Sons
</button>
<button
...
<button
  ...
  className={`px-4 py-2 rounded-lg flex items-center gap-2 text-sm transition-all ${
    soundEnabled ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-400 hover:bg-gray-500 text-white'
  }`}
>
